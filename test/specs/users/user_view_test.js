...
describe('teacher at own student\'s view', function () {
    ...
    it('routes to editing profile', function () {
        ...
        expect(browser.getUrl()).to.equal('https://local.changemyworldnow.com' +
            '/profile/97443a7e-2806-11e6-9c3e-a5b7dc3d064c/edit');
    });
...
describe('teacher at own view', function () {
    beforeEach(function () {
        login.login(USER, PASSWD);
        browser.waitForExist('#navMenu');
        browser.url('/user/c54d6b64-276d-11e6-85b7-a188177b4f51/view');
    });
    ...
    it('routes to editing profile', function () {
        ...
        browser.click('#edit-btn');
        expect(browser.getUrl()).to.equal('https://local.changemyworldnow.com' +
            '/profile/c54d6b64-276d-11e6-85b7-a188177b4f51/edit');
    });
...
describe('teacher at another adults\'s view', function () {
    it('renders 403', function () {
        login.login(USER, PASSWD);
        browser.waitForExist('#navMenu');
