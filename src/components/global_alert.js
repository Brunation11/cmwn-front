...
// type                        null                The type of the modal. SweetAlert2 comes with 5 built-in types which will show
//                                                 a corresponding icon animation: warning, error, success, info and question. It
//                                                 can either be put in the array under the key "type" or passed as the third
...
// showConfirmButton           true                If set to false, a "Confirm"-button will not be shown. It can be useful when
//                                                 you're using custom HTML description.
// showCancelButton            false               If set to true, a "Cancel"-button will be shown, which the user can click on to
//                                                 dismiss the modal.
// confirmButtonText           "OK"                Use this to change the text on the "Confirm"-button.
// cancelButtonText            "Cancel"            Use this to change the text on the "Cancel"-button.
// confirmButtonColor          "#3085d6"           Use this to change the background color of the "Confirm"-button (must be a HEX
//                                                 value).
// cancelButtonColor           "#aaa"              Use this to change the background color of the "Cancel"-button (must be a HEX
//                                                 value).
...
// buttonsStyling              true                Apply default swal2 styling to buttons. If you want to use your own classes (
...
// showCloseButton             false               Set this parameter to true to show close button in top right corner of the
//                                                 modal.
// preConfirm                  null                Function to execute before confirm, should return Promise, see usage example.
// imageUrl                    null                Add a customized icon for the modal. Should contain a string with the path or
//                                                 URL to the image.
...
// input                       null                Input field type, can be text, email, password, textarea, select, radio, and
//                                                 checkbox.
// inputPlaceholder            ""                  Input field placeholder.
// inputValue                  ""                  Input field initial value.
// inputOptions                {}                  If input parameter is set to select, you can provide options. Object keys will
//                                                 represent options values, object values will represent options text values.
// inputAutoTrim               true                Automatically remove whitespaces from both ends of a result string. Set this
